...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className='relative text-white rounded-full backdrop-blur-xl bg-transparent border border-transparent shadow-input flex justify-center space-x-4 px-8 py-6'
    >
      {children}
    </nav>
  );
