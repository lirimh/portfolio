        ...
        <div>
          ...
          <div className="grid lg:grid-cols-3 grid-cols-2 gap-4">
            ...
            <Image
              ...
              width={500}
              height={500}
              className="rounded-lg object-cover object-center h-40 md:h-44 lg:h-80 w-full max-w-32 lg:max-w-72 shadow-[0_0_24px_rgba(34,_42,_53,_0.06),_0_1px_1px_rgba(0,_0,_0,_0.05),_0_0_0_1px_rgba(34,_42,_53,_0.04),_0_0_4px_rgba(34,_42,_53,_0.08),_0_16px_68px_rgba(47,_48,_55,_0.05),_0_1px_0_rgba(255,_255,_255,_0.1)_inset]"
            />
          </div>
        </div>
      ),
