      ...
      <AuroraBackground>
        ...
        >
          <div className="flex-col text-center justify-center items-center">
            ...
            />
            <div className="bg-clip-text mt-3 px-20 lg:px-0 text-transparent font-normal drop-shadow-2xl text-md text-center md:text-4xl lg:text-xl bg-gradient-to-b from-white/80 to-white/20">
            ...
            <div className="gap-5 flex justify-center py-3">
              <Button
                onClick={() =>
                  (window.location.href = "mailto:lirimi1996@gmail.com")
                }
